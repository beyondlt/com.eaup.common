 ...
 */
public class CrossCookieSerializer  implements CookieSerializer {
    ...
    private String base64Decode(String base64Value) {
        try {
            byte[] e = CorssCookieBase64.decode(base64Value.getBytes());
            return new String(e);
    ...
    private String base64Encode(String value) {
        byte[] encodedCookieBytes = CorssCookieBase64.encode(value.getBytes());
